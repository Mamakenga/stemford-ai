...
#### Уровень 3: Two-Agent Gate

Executor **никогда** не деплоит сам. Только после вердикта Reviewer с P1=0.
Разные токены и права для executor/reviewer (дополнение Codex).
