...
|---|--------|----------|------|
| OI-8 | Довести EC-1 до DoD по latency (`p95 < 2s`) | Smoke H-10: факт `p50=4s`, `p95=6s`; нужен runtime-level fast-path (бypass LLM) для read-интентов в Telegram bridge | §28.4.1 / §29.4.4 |
