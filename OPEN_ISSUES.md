...
|---|--------|----------|------|
| OI-8 | ~~Довести EC-1 до DoD по latency (`p95 < 2s`)~~ **DEFERRED** | Факт: `p50=4s`, `p95=6s` (30x улучшение с ~120s). Текущая скорость достаточна. Runtime bypass отложен до появления реальных запросов от Натальи. | §28.4.1 / §29.4.4 |
